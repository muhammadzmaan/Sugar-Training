...
?>
<?php
// Merged from custom/Extension/modules/Accounts/Ext/LogicHooks/beforesavelogichook.php


$hook_array['before_save'][] = Array (
    1,
    'Hook for checking type field changes before saving',
    'custom/modules/Accounts/bslogic.php',
    'bslogic',
    'bslogicmethod'
);
...
?>
<?php
// Merged from custom/Extension/modules/Accounts/Ext/LogicHooks/afterretrievelogichook.php


    $hook_array['after_retrieve'][] = Array(
        1,
        'Hook to change description after retrieving',
        'custom/modules/Accounts/arlogic.php',
        'arlogic',
        'arlogicmethod'
    );
?>
