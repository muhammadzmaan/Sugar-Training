 ...
 * PLACE ANY CUSTOMIZATIONS IN CMP_first_custom_module
 */

require_once 'include/SugarObjects/templates/person/Person.php';

class CMP_first_custom_module_sugar extends Person {
    public $new_schema = true;
    public $module_dir = 'CMP_first_custom_module';
    public $object_name = 'CMP_first_custom_module';
    public $table_name = 'cmp_first_custom_module';
