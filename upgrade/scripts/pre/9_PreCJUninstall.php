...
class SugarUpgradePreCJUninstall extends UpgradeScript
{
    ...
    private $deleteFiles = [
        ...
        'custom/Extension/modules/DRI_SubWorkflows/Ext/LogicHooks/orderMapping.php',
        'custom/Extension/modules/DRI_SubWorkflows/Ext/Dependencies/orderMapping.php',
        'custom/Extension/modules/ForecastManagerWorksheets/Ext/LogicHooks/orderMapping.php',
        ...
        'custom/Extension/modules/DRI_Workflow_Templates/Ext/LogicHooks/orderMapping.php',
        'custom/Extension/modules/Administration/Ext/Administration/dri_customer_journey_settings.php',
        'custom/Extension/modules/Dashboards/Ext/LogicHooks/orderMapping.php',
        ...
        'custom/Extension/modules/Opportunities/Ext/LogicHooks/orderMapping.php',
        ...
        'custom/Extension/modules/DRI_Workflows/Ext/LogicHooks/orderMapping.php',
        ...
        'custom/Extension/modules/Schedulers/Ext/ScheduledTasks/orderMapping.php',
        ...
        'custom/Extension/modules/RevenueLineItems/Ext/LogicHooks/orderMapping.php',
        'custom/Extension/modules/DataPrivacy/Ext/LogicHooks/orderMapping.php',
        'custom/Extension/modules/DRI_SubWorkflow_Templates/Ext/LogicHooks/orderMapping.php',
        ...
        'custom/Extension/modules/ForecastWorksheets/Ext/LogicHooks/orderMapping.php',
        'custom/Extension/modules/DRI_Workflow_Task_Templates/Ext/LogicHooks/orderMapping.php',
        ...
        'custom/Extension/application/Ext/LogicHooks/orderMapping.php',
        ...
        'custom/Extension/application/Ext/ScheduledTasks/orderMapping.php',
        'custom/Extension/modules/Contacts/Ext/LogicHooks/orderMapping.php',
        'custom/Extension/modules/Users/Ext/LogicHooks/orderMapping.php',
        'custom/Extension/modules/Cases/Ext/LogicHooks/orderMapping.php',
        'custom/Extension/modules/Accounts/Ext/LogicHooks/orderMapping.php',
        ...
        'custom/Extension/modules/Opportunities/Ext/Vardefs/orderMapping.php',
        ...
        'custom/Extension/modules/Cases/Ext/Vardefs/orderMapping.php',
        ...
        'custom/Extension/modules/Contacts/Ext/Vardefs/orderMapping.php',
        'custom/Extension/modules/Contacts/Ext/LogicHooks/denorm_field_hook.php',
    ];
}
